...
def import_last_30_games():
    try:
        print("Начинаем импорт последних 30 игр NBA")

        today = datetime.today().date()
        three_months_ago = today - timedelta(days=150)  # 3 месяца назад
        ...
        response = requests.get(
            ...
            params={
                ...
                "per_page": 100,   # берём больше, чтобы хватило завершённых игр
            },
            headers=headers
        )
        ...
        db.session.commit()
        print(f"Импорт завершён, добавлено {added} игр.")
